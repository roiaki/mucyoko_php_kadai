...
if( !empty($_GET['message_id']) && empty($_POST['message_id']) ) {
	...
	// トランザクション開始、トランザクションを開始する。オートコミットがオフになる。
	// オートコミットモードがオフの間、 PDO オブジェクトを通じてデータベースに加えた変更は PDO::commit() をコールするまでコミットされない
	...
	try {
		...
		// bindValue:値をバインド　第3引数：データ型　スコープ演算子：「::」 クラスの定数や静的なメソッドにアクセスする演算子。
